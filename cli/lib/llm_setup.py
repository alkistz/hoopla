...
def answer_with_citations(query: str, results):
    client = create_gemini_client()
    prompt = answer_with_citations_prompt(query, results)
...
def answer_question(question: str, context):
    client = create_gemini_client()
    prompt = answer_question_prompt(question, context)
...
def answer_with_citations_prompt(query: str, results):
...
def answer_question_prompt(question: str, context):
